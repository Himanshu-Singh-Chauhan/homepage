<!-- Attributions to icons used at end of file -->

<template>
  <!-- Gilroy light 18px for top left logo - himanshu chauhan -->
  <div>
    ...
    <!-- <p class="my-3" @click="copyEmail">himanshusinghc2001@gmail.com <p class="inline hover:cursor-pointer py-1 pl-2 lg:hover:bg-slate-800/50">copy email</p></p> -->
    <p class="my-3" @click="copyEmail">
      himanshusinghc2001@gmail.com
      <!-- <img src="../assets/copy1.png" class="h-8 w-8 inline rounded hover:cursor-pointer p-1 lg:hover:bg-slate-600/50" alt="copy email"> -->
    </p>
...
export default {
  ...
  methods: {
    copyEmail() {
      ...
      // execCommand is deprecated and theres no alternative, instead there is a web clipboard API,
      // but since that is still not widely supported in all browsers versions, i am still using this for now.
      document.body.removeChild(emailInput);
      this.copied = true;

      // Reset copied status after few seconds.
      this.setTimeout(() => {
        this.copied = false;
      }, 3000);
    },
...
<!-- Instagram  -->
<!-- <a href="https://www.flaticon.com/free-icons/instagram" title="instagram icons">Instagram icons created by Ruslan Babkin - Flaticon</a> -->
